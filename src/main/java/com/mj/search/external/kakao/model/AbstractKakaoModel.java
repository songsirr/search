...
public abstract class AbstractKakaoModel implements IModel {

    protected AbstractKakaoModel(final Builder builder) {
        assert (builder != null);
    }
    ...
    public static abstract class JsonUtil<T> implements IModel.IJsonUtil<T> {
